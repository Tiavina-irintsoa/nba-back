package main.java.nba.stats;

import main.java.nba.stats.services.JoueurService;
import main.java.nba.stats.tools.Util;
import java.util.*;
  ...
  public ResponseEntity<Map<String, Object>> update(
    ...
    try {
      ...
      if (to_update.isPresent()) {
        Joueur updated = to_update.get();
        updated.setMarque(new Marque(joueur.getMarque().getIdMarque()));
        updated.setMatricule(joueur.getMatricule());
